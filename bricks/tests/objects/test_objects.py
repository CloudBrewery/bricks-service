...
from bricks.tests import base as test_base


class MyObj(base.BricksObject):
    version = '1.0'
    fields = {'foo': int,
              'bar': str,
              'missing': str,
...
class TestMetaclass(test_base.TestCase):
    def test_obj_tracking(self):
        ...
        @six.add_metaclass(base.BricksObjectMetaclass)
...
class TestUtils(test_base.TestCase):
    ...
    def test_obj_to_primitive_list(self):
        class MyList(base.ObjectListBase, base.BricksObject):
            pass
        mylist = MyList()
...
class _LocalTest(_BaseTestCase):
    def setUp(self):
        ...
        # Just in case
        base.BricksObject.indirection_api = None
...
def things_temporarily_local():
    ...
    _api = base.BricksObject.indirection_api
    base.BricksObject.indirection_api = None
    yield
    base.BricksObject.indirection_api = _api


class _TestObject(object):
    def test_hydration_type_error(self):
        primitive = {'bricks_object.name': 'MyObj',
                     'bricks_object.namespace': 'bricks',
                     'bricks_object.version': '1.0',
                     'bricks_object.data': {'foo': 'a'}}
    ...
    def test_hydration(self):
        primitive = {'bricks_object.name': 'MyObj',
                     'bricks_object.namespace': 'bricks',
                     'bricks_object.version': '1.0',
                     'bricks_object.data': {'foo': 1}}
        obj = MyObj.obj_from_primitive(primitive)
        self.assertEqual(obj.foo, 1)

    def test_hydration_bad_ns(self):
        primitive = {'bricks_object.name': 'MyObj',
                     'bricks_object.namespace': 'foo',
                     'bricks_object.version': '1.0',
                     'bricks_object.data': {'foo': 1}}
    ...
    def test_dehydration(self):
        expected = {'bricks_object.name': 'MyObj',
                    'bricks_object.namespace': 'bricks',
                    'bricks_object.version': '1.0',
                    'bricks_object.data': {'foo': 1}}
        obj = MyObj()
    ...
    def test_changes_in_primitive(self):
        ...
        self.assertTrue('bricks_object.changes' in primitive)
    ...
    def test_unknown_objtype(self):
        self.assertRaises(exception.UnsupportedObjectError,
                          base.BricksObject.obj_class_from_name, 'foo', '1.0')
    ...
    def test_base_attributes(self):
        ...
        obj.updated_at = dt
        expected = {
            'bricks_object.name': 'MyObj',
            'bricks_object.namespace': 'bricks',
            'bricks_object.version': '1.0',
            'bricks_object.changes': [
...
class TestObjectListBase(test_base.TestCase):
    def test_list_like_operations(self):
        class Foo(base.ObjectListBase, base.BricksObject):
            pass
    ...
    def test_serialization(self):
        ...
        obj2 = base.BricksObject.obj_from_primitive(obj.obj_to_primitive())
...
class TestObjectSerializer(test_base.TestCase):
    def test_serialize_entity_primitive(self):
        ser = base.BricksObjectSerializer()
    ...
    def test_object_serialization(self):
        ...
        self.assertTrue('bricks_object.name' in primitive)
    ...
    def test_object_serialization_iterables(self):
        ...
        for iterable in (list, tuple, set):
            ...
            for item in primitive:
                self.assertFalse(isinstance(item, base.BricksObject))
