...
from pecan.jsonify import encode

from bricks.tests.db import utils as db_utils

ADMIN_TOKEN = '4562138218392831'
MEMBER_TOKEN = '4562138218392832'


def get_test_brick_json(**kw):
    brack = db_utils.get_test_brick(**kw)
    brack['deployed_at'] = brack['deployed_at'].isoformat()
    return brack
