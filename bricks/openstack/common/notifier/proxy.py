...
"""
A temporary helper which emulates bricks.messaging.Notifier.

This helper method allows us to do the tedious porting to the new Notifier API
as a standalone commit so that the commit which switches us to bricks.messaging
...
from bricks.openstack.common.notifier import api as notifier_api
